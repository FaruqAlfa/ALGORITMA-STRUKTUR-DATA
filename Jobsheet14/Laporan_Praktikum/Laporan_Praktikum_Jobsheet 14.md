...
**Jawab: 1. Pencarian Melebar (Breadth First Search atau BFS) Untuk Mencari
2. Pencarian Mendalam (Depth First Search atau DFS) Untuk Mencari
...
5. Mengapa pada method main harus menggunakan try-catch Exception ?
	...
	**Jawab: Agar program yang error dapat tetap berjalan dan tidak terhenti**
